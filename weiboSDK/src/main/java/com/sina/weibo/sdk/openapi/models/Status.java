...
public class Status {
    ...
    public int source_allowclick;           //是否允许点击
    public int source_type;                 //来源类型
    /**
    ...
    //    public ArrayList<String> darwin_tags;
    public String rId;
    public int userType;
    ...
    public static Status parse(JSONObject jsonObject) {
        ...
        //补充
        status.textLenth = jsonObject.optInt("textLength");
        status.source_allowclick = jsonObject.optInt("source_allowclick");
        status.source_type = jsonObject.optInt("source_type");
        status.biz_feature = jsonObject.optInt("biz_feature");
        status.rId = jsonObject.optString("rId");
        status.userType = jsonObject.optInt("userType");
        status.cardid = jsonObject.optString("cardid");
        // Have NOT supported
